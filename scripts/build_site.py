  ...
  <header class="site-header">
    <div class="site-header-inner">
      ...
      <nav class="nav" aria-label="Primary">
        <a href="{zh_href}">中文总论</a>
        <a href="{en_href}">English Overview</a>
...
def build_index() -> None:
    ...
    <section class="hero">
      ...
      <div class="actions">
        <a class="button primary" href="zh/eight-layer-architecture.html">阅读中文总论</a>
        <a class="button" href="en/eight-layer-architecture.html">Read English Overview</a>
      </div>
    </section>
    ...
    <section class="grid" aria-label="Published articles">
      <article class="article-card">
        ...
        <p><a href="zh/eight-layer-architecture.html">打开文章</a></p>
      </article>
      ...
      <article class="article-card">
        ...
        <p><a href="en/eight-layer-architecture.html">Open article</a></p>
      </article>
    </section>
...
"""
    (ROOT / "index.html").write_text(
        page_shell(
            ...
            "site.css",
            "./",
            "zh/eight-layer-architecture.html",
            "en/eight-layer-architecture.html",
        )
    )
...
def main() -> None:
    build_index()
    build_article(
        "zh/eight-layer-architecture.md",
        "zh/eight-layer-architecture.html",
        "可信取数+深度业务洞察：企业 AI 分析师的八层架构",
        "eight-layer-architecture.html",
        "../en/eight-layer-architecture.html",
    )
    build_article(
        "en/eight-layer-architecture.md",
        "en/eight-layer-architecture.html",
